...
% Load from ex5data1: 
% You wil l have X, y, Xval, yval, Xtest, ytest in your environment
load ('ex5data1.mat');
...
title('Learnin g curve for linear regression')
...
%% Testing the lambda = 3
fprintf('\n===================Testing====================\n\n');
lambda = 3;
error_test = test(X_poly,y,X_poly_test,ytest,lambda);
fprintf('\nThe Test Error is: %f\n', error_test);
